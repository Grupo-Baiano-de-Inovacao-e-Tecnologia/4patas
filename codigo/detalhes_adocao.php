...
$situacao = htmlspecialchars($detalhes_solicitacao['status']);
?>
...
<head>
    ...
    <title>Detalhes da Adoção</title>
</head>
<body>
    <header>
        <div id="logo">
    ...
    <div id="container">
        ...
        <div class="info">
            <p id="dt_solic2">Inicio: <?php echo date('d/m/Y', strtotime($detalhes_solicitacao['data_inicio'])); ?></p>
            <p id="dt_solic2">Fim: <?php echo date('d/m/Y', strtotime($detalhes_solicitacao['data_fim'])); ?></p>
            <p id="situacao"><?php echo $situacao === 'aprovado' ? 'APROVADA' : ($situacao === 'recusado' ? 'RECUSADA' : 'EM ANÁLISE'); ?></p>
            <a id="voltarbnt" href="#" onclick="history.back();">VOLTAR</a>
        </div>
    </div>
