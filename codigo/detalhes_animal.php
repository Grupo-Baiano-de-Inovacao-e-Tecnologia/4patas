...
$query = "SELECT a.*, ab.nome AS abrigo_nome FROM animal a JOIN abrigo ab ON a.abrigo_id = ab.id WHERE a.id = ?";
...
<body>
    <header>
        ...
        <nav>
            ...
            <a href="minhas_solicitações.php">Minhas Solicitações</a>
    ...
    <div id="container">
        ...
        <div class="animal-detalhes">
            ...
            <div class="grupo-formulario">
                ...
                <div class="linha">
                    ...
                    <input type="text" id="abrigo" name="abrigo" readonly value="Sou do Abrigo <?php echo htmlspecialchars($abrigo_nome); ?>">
                </div>
        ...
        <div class="botoes">
            ...
            <button onclick="window.location.href='solicitar_adocao.php?animal_id=<?php echo $animal->id; ?>'">ADOTAR</button>
        </div>
    </div>
